...
class Camera:
  ...
  def write_image(self, filepath, img):
    """Speichert ein einzelnes Bild an der angegebenen Datei.
    
    Args:
      img: Das Bild als NumPy-Array (BGR oder RGB).
      filepath: Der Speicherort der Datei (z. B. "output.png").
    """
    # Sicherstellen, dass das Bild im richtigen Format ist (BGR, nicht RGB)
